...
import {AccessRole, AccessUser} from "@models/AccessModels";
...
export class AccessApi {
    ...
    // command mirrors the backend UserRoleChangeRequest contract (add|remove only;
    // activate/inactivate go through setUserStatus).
    static setUserRole(user: AccessUser, role: string | undefined, command: "add" | "remove", after: (result: AccessUser) => void) {
        try {
