...
import static org.apache.camel.karavan.persistence.AccessCacheEntity.TABLE_NAME;

/** Users, roles and git configs serialized as JSONB. */
@Entity
@Table(name = TABLE_NAME, indexes = {
        @Index(name = "idx_access_type", columnList = "type"),
        @Index(name = "idx_access_last_update", columnList = "last_update")
})
public class AccessCacheEntity extends KeyValueCacheEntity {
