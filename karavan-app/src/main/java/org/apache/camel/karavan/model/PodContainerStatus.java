...
@NoArgsConstructor
@AllArgsConstructor
@ToString(of = {"projectId", "containerName", "containerId", "image", "ports", "env", "type", "memoryInfo", "cpuInfo",
        "created", "finished", "commands", "state", "phase", "codeLoaded", "inTransit", "initDate", "podIP", "commit", "labels"})
